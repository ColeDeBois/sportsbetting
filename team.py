...
batting_order_dict={
   ...
   'MIN':['Byron Buxton','Donovan Solano','Carlos Correa','Kyle Farmer','Royce Lewis','Willi Castro','Alex Kirilloff','Ryan Jeffers','Michael Taylor'],
   ...
   'MIA':['Jorge Soler','Luis Arraez','Bryan De La Cruz','Garrett Cooper','Jesus Sanchez','Joey Wendle','Jonathan Davis','Nick Fortes','Garrett Hampson'],
