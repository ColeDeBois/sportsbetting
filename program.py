...
def run_sim(away_team, home_team, iters=100):
    '''runs a simulation of a baseball game 100 times
    returns the average score of the away team and the home team, 
    also prints the transcript of the last game played'''
    list_of_scores=[]
    avg_away_score=0
    avg_home_score=0
